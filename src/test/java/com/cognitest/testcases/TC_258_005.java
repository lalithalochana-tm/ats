...
public class TC_258_005 extends CognitestPageHook {

    @BeforeTest
    public void setReportValues() {
        testcaseName = "TC-258-005 User logs in and performs a search with Policy Number and Borrower First Name fields populated.";
        testDescription = "User logs in and performs a search with Policy Number and Borrower First Name fields populated.";
        authors = "Cognitest";
    ...
    public Object[][] getTestData() {
        String testDataPath = "src/test/java/com/cognitest/testcases/TestData/testData_TC-258-005.json"; 
