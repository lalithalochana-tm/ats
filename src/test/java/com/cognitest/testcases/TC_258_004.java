...
public class TC_258_004 extends CognitestPageHook {

    @BeforeTest
    public void setReportValues() {
        testcaseName = "TC-258-004 User logs in and performs a search with multiple fields populated, including optional fields.";
        testDescription = "User logs in and performs a search with multiple fields populated, including optional fields.";
        authors = "Cognitest";
    ...
    public Object[][] getTestData() {
        String testDataPath = "src/test/java/com/cognitest/testcases/TestData/testData_TC-258-004.json";
