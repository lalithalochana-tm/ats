...
public class TC_258_010 extends CognitestPageHook {

    @BeforeTest
    public void setReportValues() {
        testcaseName = "TC-258-010 User logs in and performs a search with Borrower First Name and Transaction ID fields populated.";
        testDescription = "User logs in and performs a search with Borrower First Name and Transaction ID fields populated.";
        authors = "Cognitest";
    ...
    public Object[][] getTestData() {
        String testDataPath = "src/test/java/com/cognitest/testcases/TestData/testData_TC-258-010.json"; 
    ...
    public void dynamicTestMethodName(Map<String, String> testData) throws InterruptedException {
        new MenuPage()
            ...
            .fillBorrowerFirstName(testData.get("BORROWER_FIRST_NAME"))
            .verifyBorrowerFirstName(testData.get("BORROWER_FIRST_NAME"))
            .fillTransactionId(testData.get("TRANSACTION_ID"))
            .verifyTransactionId(testData.get("TRANSACTION_ID"))
            .clickSearchButton()
            .verifySearchResultsText()
            .clickTransactionLink(testData.get("TRANSACTION_ID_LINK"))
