...
public class TC_258_002 extends CognitestPageHook {

    @BeforeTest
    public void setReportValues() {
        testcaseName = "TC-258-002 User logs in and performs a search with only the Loan Number field populated.";
        testDescription = "User logs in and performs a search with only the Loan Number field populated.";
        authors = "Cognitest";
    ...
    public Object[][] getTestData() {
        String testDataPath = "src/test/java/com/cognitest/testcases/TestData/testData_TC-258-002.json"; 
    ...
    public void dynamicTestMethodName(Map<String, String> testData) throws InterruptedException {
        new MenuPage()
            ...
            .clickTransactionLink(testData.get("LOAN_NUMBER"))
            .verifyLoanSummaryText();
